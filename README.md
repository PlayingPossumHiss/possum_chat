...
При запуске в папке с приложением должен лежать файл config.json следующего вида (сейчас он генерируется уже автоматом и настройки меняются на соответствующей вкладке)
